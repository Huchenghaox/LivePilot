...
目标：先把真实可用版本跑在华为 Ubuntu 服务器上，再用 Cloudflare Tunnel 暴露 `www.haoxagent.com` 和 `api.haoxagent.com`。
...
CORS_ORIGINS=https://www.haoxagent.com,https://api.haoxagent.com
...
- `www.haoxagent.com` -> `http://127.0.0.1:3000`
- `api.haoxagent.com` -> `http://127.0.0.1:8000`
